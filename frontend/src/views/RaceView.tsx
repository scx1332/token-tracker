  ...
  return (
    <>
      ...
      <div className="chart-note" style={{ marginTop: 10 }}>
        ...
        lab's field, and the last bar is the labs outside the top eight); lines follow the top ten models individually. The shaded band on daily views is the day still filling — shown, never extrapolated.
      </div>
    </>
  );
}
